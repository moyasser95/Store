...
Hello @if (Auth::guard('web')->check())
   <span class="text-info text-capitalize"> {{ Auth::guard('web')->user()->name }}</span>
@endif
</div>
...
<div class="search-input">
        ...
        <input class="_search" type="text" placeholder="Search"  >
...
<i class="lni lni-cart"></i>
 <span class="total-items total_cart">{{ $num_pro??=0 }}</span>
</a>

<div class="shopping-item">
<div class="dropdown-cart-header">
<span class="num_items">{{ $num_pro??=0 }} Items</span>
...
<ul class="shopping-list">
    ...
    <a class="cart-img" href="product-details.html"><img src="{{asset('storage/images/'.$data_cart->products[0]->images[0]->file )}}" alt="#"></a>
    </div>
    <div class="content">
